...
- **Tooling docs** — [Microsoft Power BI](https://learn.microsoft.com/power-bi/) · [NLTK VADER](https://www.nltk.org/api/nltk.sentiment.vader.html) · [SQL Server T-SQL](https://learn.microsoft.com/sql/t-sql/)
...
Read the **six-slide executive summary** in [`/presentation/`](presentation/) — it covers the full story from problem to recommendations.
